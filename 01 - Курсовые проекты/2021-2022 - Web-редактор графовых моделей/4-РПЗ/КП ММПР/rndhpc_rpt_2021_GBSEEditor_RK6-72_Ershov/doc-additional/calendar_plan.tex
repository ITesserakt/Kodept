...
\hline
\textbf{№ п/п} & \textbf{Наименование этапов \doctypec} &	\multicolumn{2}{|P{0.13\textwidth}|}{\textbf{Сроки выполнения этапов}} & \multicolumn{2}{|P{0.24\textwidth}|}{\textbf{Отметка о выполнении}} \\
\cline{3-6}
...
\noindent\begin{tabular}{ll}%p{0.5\textwidth}p{0.53\textwidth}}
