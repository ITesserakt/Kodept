...
\newabbreviation[category=initialism]{AS}{AS}{Сервер приложений (англ. Application Server).}
\newabbreviation[category=initialism]{ASUTP}{АСУ ТП}{Автоматизированная система управления технологическими процессами.}
\newabbreviation[category=initialism]{aclss}{ACLSS}{Системный класс функции в системе \gls{dcs-gcd}.}
\newabbreviation[category=initialism]{atype}{ATYPE}{Предметный тип функции в системе \gls{dcs-gcd}.}
\newabbreviation[category=initialism]{inpd}{ИД}{исходные данные}
