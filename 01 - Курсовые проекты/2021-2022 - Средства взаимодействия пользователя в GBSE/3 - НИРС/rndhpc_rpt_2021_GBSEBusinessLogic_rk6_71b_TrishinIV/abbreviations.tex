...
\newabbreviation[category=initialism]{CASE}{CASE}{Computer-aided Software Engineering}
\newabbreviation[category=initialism]{DFD}{DFD}{диаграмма потоков данных (Data Flow Diagram)}
\newabbreviation[category=initialism]{GUIen}{GUI}{Graphical User Interface}
\newabbreviation[category=initialism]{DOT}{DOT}{язык описания графов}
\newabbreviation[category=initialism]{GBSE}{GBSE}{Graph-based Software Engineering}
\newabbreviation[category=initialism]{GUIru}{ГПИ}{Графический пользовательский интерфейс}
\newabbreviation[category=initialism]{ЛПР}{ЛПР}{лицо, принимающее решение}
