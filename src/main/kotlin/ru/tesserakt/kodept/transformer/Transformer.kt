...
fun <N : AST.Node> N.acceptTransform(transformer: Transformer): N = when (this) {
    ...
    is AST.UnresolvedFunctionCall -> transformer.visit(this)
    is AST.UnresolvedReference -> transformer.visit(this)
    ...
    is AST.StructDecl.Parameter -> transformer.visit(this)
    is AST.EnumDecl -> transformer.visit(this)
    is AST.ModuleDecl -> transformer.visit(this)
    is AST.FunctionDecl.Parameter -> transformer.visit(this)
