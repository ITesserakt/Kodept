...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.35]{ResearchNotes/rndfem_not_gui_2022_11_04_images/picture1.png}
...
\begin{lstlisting}[frame=single, label={dockerfile.prod}, caption={\textsf{Dockerfile.prod}}, language=Dockerfile.prod] 
# BUILDER
...
\begin{lstlisting}[frame=single, label={docker-compose.prod}, caption={\textsf{docker-compose.prod.yml}}, language=docker-compose.prod] 
version: '3.8'
...
\begin{lstlisting}[frame=single, label={views}, caption={\textsf{views.py}}, language=Python] 
...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.35]{ResearchNotes/rndfem_not_gui_2022_11_04_images/picture2.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.35]{ResearchNotes/rndfem_not_gui_2022_11_04_images/picture3.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.35]{ResearchNotes/rndfem_not_gui_2022_11_04_images/picture4.png}
